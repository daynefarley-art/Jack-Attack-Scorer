            ...
            <Card key={idx}>
              ...
              <div className="grid md:grid-cols-6 gap-2">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 rounded-xl border text-sm" value={e.third} onChange={ev=>updateEnd(idx,{third:ev.target.value})}>
                    <option value=""></option>
                    <option value="A">{teams.A}</option>
                    <option value="B">{teams.B}</option>
                  </select>
                ...
                <div>
                  ...
                  <Input type="number" value={e.adjA} onChange={ev=>updateEnd(idx,{adjA:Number(ev.target.value)})}/>
                </div>
                <div>
                  <Label>Adj {teams.B}</Label>
                  <Input type="number" value={e.adjB} onChange={ev=>updateEnd(idx,{adjB:Number(ev.target.value)})}/>
                </div>
                <div className="md:col-span-2">
                  <Label>Notes</Label>
                  <Input value={e.notes} onChange={ev=>updateEnd(idx,{notes:ev.target.value})}/>
                </div>
              </div>
              <div className="mt-2 text-xs opacity-70">{r.detail}</div>
            </Card>
          )
        })}
      </div>
