// api/send-email.js (CommonJS runtime)
...
module.exports = async (req, res) => {
  try {
    ...
    // Body can be string or object depending on platform—normalize it
    ...
    if (r?.error) {
      return res.status(500).json({ error: r.error.message || 'Send failed' });
    }
